...
![Version](https://img.shields.io/badge/version-1.9.9-C41E0E?style=flat-square)
...
![Tests](https://img.shields.io/badge/tests-1326%20passing-success?style=flat-square)
...
NEKOVA was born in Nigeria to prove that world-class programming languages can come from anywhere. **1,326 tests. 26 development phases. One language.**
...
├── tests/                ← Test suite (1,326 tests across 26 phases)
├── main.py                ← Entry point
