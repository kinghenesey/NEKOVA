...
![Version](https://img.shields.io/badge/version-1.9.8-C41E0E?style=flat-square)
...
![Tests](https://img.shields.io/badge/tests-1276%20passing-success?style=flat-square)
...
NEKOVA was born in Nigeria to prove that world-class programming languages can come from anywhere. **1,276 tests. 25 development phases. One language.**
...
├── tests/                ← Test suite (1,276 tests across 25 phases)
├── main.py                ← Entry point
