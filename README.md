...
![Version](https://img.shields.io/badge/version-1.9.3-C41E0E?style=flat-square)
...
![Tests](https://img.shields.io/badge/tests-1177%20passing-success?style=flat-square)
...
NEKOVA was born in Nigeria to prove that world-class programming languages can come from anywhere. **1,177 tests. 20 development phases. One language.**
...
├── tests/                ← Test suite (1,177 tests across 20 phases)
├── main.py                ← Entry point
