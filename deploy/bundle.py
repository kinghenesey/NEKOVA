# =============================================================
# AION Deploy — App Bundler
# =============================================================
# Packages an AION app into a self-contained deployment bundle.
# The bundle includes everything needed to run the app
# on any server without AION pre-installed.
#
# Usage:
...
class AppBundler:
    """
    Creates a self-contained deployment bundle from an AION app.
    """

    def bundle(self, filepath: str) -> str:
        """
        Bundle an AION app into a temp directory.
    ...
    def _copy_app(self, filepath: str,
        ...
        """Copy the AION source file to the bundle."""
        dest = os.path.join(bundle_dir, f"{app_name}.aion")
        shutil.copy2(filepath, dest)

        # Copy AION core modules needed at runtime
...
if __name__ == "__main__":
    ...
    runner   = AIONRunner(filepath=filepath)
